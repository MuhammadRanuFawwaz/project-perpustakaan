...
<body>
    ...
    <div class="admin-login-wrapper">
        @auth
        <a href="{{ route('dashboard') }}" class="admin-login-btn">
            Dashboard
        </a>
        @else
                ...
                <form action="{{ route('pengunjung.form.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                <label>Status</label>
                                <input type="text" id="status" class="form-control" placeholder="Status otomatis" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_pengunjung" class="form-control" placeholder="Nama otomatis" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                <label>Kelas</label>
                                <input type="text" id="kelas" class="form-control" placeholder="Kelas otomatis" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                <label>Jurusan</label>
                                <input type="text" id="jurusan" class="form-control" placeholder="Jurusan otomatis" readonly>
                            </div>
                        </div>
                    </div>
