    ...
    <div class="dashboard-container">
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="cards">
                ...
                <div class="card">
                    <div class="card-icon">
                        <img src="{{ asset('icon/pengunjung.png') }}">
                    </div>
                ...
                <div class="card">
                    ...
                    <div>
                        ...
                        <div class="card-number">{{ $total_judul_buku }}</div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div>
                        ...
                        <div class="card-number">{{ $total_jumlah_buku }}</div>
                    </div>
                </div>

                <div class="card">
                    <div class="card-icon">
                        <img src="{{ asset('icon/pinjam.png') }}">
                    </div>
            ...
            <div class="box">
                ...
                <div class="warning-sidebar">
                    ...
                    <div class="warning-menu active" id="btnStatPengunjung">
                        Pengunjung
                    </div>

                    <div class="warning-menu" id="btnStatBuku">
                        Buku
                    </div>
                ...
                <div id="statistikPengunjung">
                    ...
                    <div class="box-title">
                        Statistik Pengunjung Berdasarkan Kelas dan Jurusan
                    </div>
                    ...
                    <p>Belum ada data statistik pengunjung.</p>

                    @endforelse

                </div>

                <div id="statistikBuku" style="display:none;">

                    <div class="box-title">
                        Statistik Buku per Kategori / Jurusan
                    </div>

                    @php
                    $maxTotalBuku = $statistikBukuKategori->max('total_buku') ?: 1;
                    @endphp

                    @forelse($statistikBukuKategori as $b)
                    @php
                    $persenBuku = ($b->total_buku / $maxTotalBuku) * 100;
                    @endphp
                    ...
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            ...
                            <span>
                                {{ $b->total_judul }} judul / {{ $b->total_buku }} buku
                            </span>
                        </div>

                        <div class="stat-bar">
                            <div class="stat-fill" data-width="{{ $persenBuku }}"></div>
                        </div>
                    ...
                    <p>Belum ada data statistik buku.</p>
